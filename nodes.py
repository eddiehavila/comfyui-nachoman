...
class NACHOMAN_LoadAudioSplitDynamic:
    ...
    def split_audio(self, path, offset_seconds, scene_count=1, using_infinite_talk="false", **kwargs):
        ...
        if torchaudio is not None:
            try:
                ...
                print(f"[NACHOMAN_LoadAudioSplitDynamic] torchaudio.info failed: {e}")
        ...
        for idx, start_time in enumerate(starts):
            ...
            try:
                ...
                print(f"[NACHOMAN_LoadAudioSplitDynamic] Failed to load segment {idx+1}: {e}")
...
class NACHOMAN_LoadAudioSplit_HUMO:
    RETURN_TYPES = ("DICT", "FLOAT") + tuple(["AUDIO"] * 50)
    RETURN_NAMES = ("meta", "total_duration") + tuple([f"audio_{i}" for i in range(1, 51)])
...
class NACHOMAN_Extract_Frame_Number:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class NACHOMAN_LoadAudioSplitUpload:
    """
...
class NACHOMAN_TranscribeLyric:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
...
class NACHOMAN_LoadAudioSplit_HUMO_Transcribe:
...
##################################################
class NACHOMAN_IndexedPromptChunker:
...
class NACHOMAN_IndexedPromptChunkerV2:
    RETURN_TYPES = tuple(["STRING"] * 50)
    RETURN_NAMES = tuple([f"text_output_{i}" for i in range(1, 51)])
    FUNCTION = "split_prompt"
    CATEGORY = "NACHOMAN"
...
#########################################
import json
class NACHOMAN_PostRunIndexStepper:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "state_file_name": ("STRING", {"default": "NACHOMAN_index_state.json"}),
            }
        }
...
#########################
import json
class NACHOMAN_GetRunIndexFromJson:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    def get_index(self, any):
        ...
        try:
            ...
            json_path = os.path.join(base_path, "NACHOMAN_index_state.json")
...
NODE_CLASS_MAPPINGS = {
     "NACHOMAN_LoadAudioSplitDynamic": NACHOMAN_LoadAudioSplitDynamic,
     "NACHOMAN_LoadAudioSplit_HUMO": NACHOMAN_LoadAudioSplit_HUMO,
     "NACHOMAN_Extract_Frame_Number": NACHOMAN_Extract_Frame_Number,
     "NACHOMAN_VideoSplitter":NACHOMAN_VideoSplitter,
     "NACHOMAN_LoadAudioSplitUpload":NACHOMAN_LoadAudioSplitUpload,
     "NACHOMAN_TranscribeText":NACHOMAN_TranscribeLyric,
     "NACHOMAN_LoadAudioSplit_HUMO_Transcribe":NACHOMAN_LoadAudioSplit_HUMO_Transcribe,
     "NACHOMAN_LoadVideos":NACHOMAN_LoadVideos,
     "NACHOMAN_IndexedPromptChunker":NACHOMAN_IndexedPromptChunker,
     "NACHOMAN_IndexedPromptChunkerV2":NACHOMAN_IndexedPromptChunkerV2,
     "NACHOMAN_PostRunIndexStepper":NACHOMAN_PostRunIndexStepper,
     "NACHOMAN_GetRunIndexFromJson":NACHOMAN_GetRunIndexFromJson,
     "NACHOMAN_AudioCropTime":NACHOMAN_AudioCropTime,
     "NACHOMAN_LoadAudioSplit_HUMO_Transcribe":NACHOMAN_LoadAudioSplit_HUMO_Transcribe
...
NODE_DISPLAY_NAME_MAPPINGS = {
     ...
     "NACHOMAN_VideoSplitter":"NACHOMAN_VideoSplitter",
     "NACHOMAN_LoadAudioSplitUpload":"NACHOMAN_LoadAudioSplitUpload",
     "NACHOMAN_PromptSplitter":"NACHOMAN_PromptSplitter",
     "NACHOMAN_TranscribeText":"NACHOMAN_TranscribeLyric",
     "NACHOMAN_LoadAudioSplit_HUMO_Transcribe":"NACHOMAN_LoadAudioSplit_HUMO_Transcribe",
     "NACHOMAN_LoadVideos":"NACHOMAN_LoadVideos",
     "NACHOMAN_IndexedPromptChunker":"NACHOMAN_IndexedPromptChunker",
...
print(r"""
__/\\\\\_____/\\\_____/\\\\\\\\\___________/\\\\\\\\\__/\\\________/\\\_______/\\\\\_______/\\\\____________/\\\\_____/\\\\\\\\\_____/\\\\\_____/\\\_        
 _\/\\\\\\___\/\\\___/\\\\\\\\\\\\\______/\\\////////__\/\\\_______\/\\\_____/\\\///\\\____\/\\\\\\________/\\\\\\___/\\\\\\\\\\\\\__\/\\\\\\___\/\\\_       
  _\/\\\/\\\__\/\\\__/\\\/////////\\\___/\\\/___________\/\\\_______\/\\\___/\\\/__\///\\\__\/\\\//\\\____/\\\//\\\__/\\\/////////\\\_\/\\\/\\\__\/\\\_      
   _\/\\\//\\\_\/\\\_\/\\\_______\/\\\__/\\\_____________\/\\\\\\\\\\\\\\\__/\\\______\//\\\_\/\\\\///\\\/\\\/_\/\\\_\/\\\_______\/\\\_\/\\\//\\\_\/\\\_     
    _\/\\\\//\\\\/\\\_\/\\\\\\\\\\\\\\\_\/\\\_____________\/\\\/////////\\\_\/\\\_______\/\\\_\/\\\__\///\\\/___\/\\\_\/\\\\\\\\\\\\\\\_\/\\\\//\\\\/\\\_    
     _\/\\\_\//\\\/\\\_\/\\\/////////\\\_\//\\\____________\/\\\_______\/\\\_\//\\\______/\\\__\/\\\____\///_____\/\\\_\/\\\/////////\\\_\/\\\_\//\\\/\\\_   
      _\/\\\__\//\\\\\\_\/\\\_______\/\\\__\///\\\__________\/\\\_______\/\\\__\///\\\__/\\\____\/\\\_____________\/\\\_\/\\\_______\/\\\_\/\\\__\//\\\\\\_  
       _\/\\\___\//\\\\\_\/\\\_______\/\\\____\////\\\\\\\\\_\/\\\_______\/\\\____\///\\\\\/_____\/\\\_____________\/\\\_\/\\\_______\/\\\_\/\\\___\//\\\\\_ 
        _\///_____\/////__\///________\///________\/////////__\///________\///_______\/////_______\///______________\///__\///________\///__\///_____\/////__
